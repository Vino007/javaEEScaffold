			...
			<div class="modal-body">
					...
					<div class="form-group">
						...
						<c:choose>
							...
							<input  name="locked"  type="radio" checked="checked">锁定
							<input  name="locked"  type="radio" >未锁定
							</c:when>
							<c:otherwise>
							<input  name="locked"  type="radio" >锁定
							<input  name="locked"  type="radio" checked="checked">未锁定
							</c:otherwise>
						</c:choose>
					</div>
